...
class SocialMediaPost(BaseModel):
    ...
    content: str = Field(..., description="The article content.")

class ContentOutput(BaseModel):
    article: str = Field(..., description="The article, formatted in markdown.")
    articles: List[SocialMediaPost] = Field(..., description="A list of articles.")
...
market_news_monitor_agent = Agent(
    config=agents_config['product_news_analysis_agent'],
...
monitor_financial_news_task = Task(
    config=tasks_config['extract_product_data'],
...
posts = result.pydantic.dict()['articles']
for post in posts:
